...
class RulesTruthOrDareState extends State<RulesTruthOrDareScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Action ou vérité - Règles'),
      ),
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Chaqu\'un votre tour aléatoirement vous allez devoir choisir entre ,',
              style: TextStyle(
                fontSize: 14,
                color: Colors.black,
              ),
            ...
            const Text(
              'Si vous refusez, vous devrez boire le nombre de gorgées données.',
              style: TextStyle(
                fontSize: 14,
                color: Colors.black,
              ),
            ...
            const Text(
              'Vous pouvez aussi ajouter vos propres actions ou vérités !',
              style: TextStyle(
                fontSize: 14,
                color: Colors.black,
              ),
